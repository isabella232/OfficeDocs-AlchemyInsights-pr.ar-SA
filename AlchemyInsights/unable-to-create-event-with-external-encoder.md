...
إذا كنت تواجه مشكلة في الحصول على الترميز للعمل مع الحدث المباشر في Teams، فشاهد وثائق إعداد الترميز: تكوين ترميزات للتدفق المباشر في [Microsoft Stream](https://docs.microsoft.com/stream/live-encoder-setup)