---
title: اختبار كيمياء الصور المضمنة
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="3961d-102">الوصول إلى صفحه المجالات</span><span class="sxs-lookup"><span data-stu-id="3961d-102">Access the Domains Page</span></span>

<span data-ttu-id="3961d-103">للوصول إلى صفحه المجالات ، ما عليك سوي النقر فوق هذه الايقونه أدناه:</span><span class="sxs-lookup"><span data-stu-id="3961d-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="3961d-104">يمكنك بعد ذلك أضافه المجال أو تعديله أو ازالته.</span><span class="sxs-lookup"><span data-stu-id="3961d-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="3961d-105">لمزيد من المعلومات ، راجع [الاسئله المتداولة حول المجالات.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="3961d-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
