...
---
# <a name="access-the-domains-page"></a>الوصول إلى صفحه المجالات

للوصول إلى صفحه المجالات ، ما عليك سوي النقر علي هذا الرمز أدناه:
...
ثم يمكنك أضافه أو تعديل أو أزاله المجال الخاص بك.
لمزيد من المعلومات ، راجع [الاسئله المتداولة حول المجالات.](https://docs.microsoft.com/office365/admin/setup/domains-faq)
