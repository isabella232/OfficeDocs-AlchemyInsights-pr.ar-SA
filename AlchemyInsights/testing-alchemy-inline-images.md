...
ms.locfileid: "43759967"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="71b3a-102">الوصول إلى صفحة المجالات</span><span class="sxs-lookup"><span data-stu-id="71b3a-102">Access the Domains Page</span></span>

<span data-ttu-id="71b3a-103">للوصول إلى صفحة المجالات، ما عليك سوى النقر على هذا الرمز أدناه:</span><span class="sxs-lookup"><span data-stu-id="71b3a-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="71b3a-104">ثم يمكنك إضافة نطاقك أو تعديله أو إزالته.</span><span class="sxs-lookup"><span data-stu-id="71b3a-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="71b3a-105">لمزيد من المعلومات، راجع الأسئلة الشائعة حول [المجالات.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="71b3a-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
