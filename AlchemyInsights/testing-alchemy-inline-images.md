---
title: اختبار الصور المضمنة الخيمياء
ms.author: pebaum
author: pebaum
ms.date: 11/16/2017
ms.audience: ITPro
...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="01f4e-102">الوصول إلى صفحة المجالات</span><span class="sxs-lookup"><span data-stu-id="01f4e-102">Access the Domains Page</span></span>

<span data-ttu-id="01f4e-103">للوصول إلى صفحة المجالات، ما زال فوق هذا الرمز أدناه:</span><span class="sxs-lookup"><span data-stu-id="01f4e-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="01f4e-104">ثم يمكنك إضافة المجال أو تعديله أو إزالته.</span><span class="sxs-lookup"><span data-stu-id="01f4e-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="01f4e-105">لمزيد من المعلومات، راجع الأسئلة المتداولة حول [المجالات.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="01f4e-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
