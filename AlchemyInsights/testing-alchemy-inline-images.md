---
title: اختبار الصور المضمنة الكيمياء
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "44505042"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="584e1-102">الوصول إلى صفحة المجالات</span><span class="sxs-lookup"><span data-stu-id="584e1-102">Access the Domains Page</span></span>

<span data-ttu-id="584e1-103">للوصول إلى صفحة المجالات، ما عليك سوى النقر على هذا الرمز أدناه:</span><span class="sxs-lookup"><span data-stu-id="584e1-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="584e1-104">ثم يمكنك إضافة نطاقك أو تعديله أو إزالته.</span><span class="sxs-lookup"><span data-stu-id="584e1-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="584e1-105">لمزيد من المعلومات، راجع الأسئلة الشائعة حول [المجالات.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="584e1-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
