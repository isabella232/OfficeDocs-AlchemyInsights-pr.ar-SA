---
title: اختبار صور الكيمياء المضمنة
ms.author: pebaum
author: pebaum
ms.date: 11/16/2017
ms.audience: ITPro
...
ms.locfileid: "36743116"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="e5138-102">الوصول إلى صفحه المجالات</span><span class="sxs-lookup"><span data-stu-id="e5138-102">Access the Domains Page</span></span>

<span data-ttu-id="e5138-103">للوصول إلى صفحه المجالات ، ما عليك سوي النقر علي هذا الرمز أدناه:</span><span class="sxs-lookup"><span data-stu-id="e5138-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="e5138-104">ثم يمكنك أضافه أو تعديل أو أزاله المجال الخاص بك.</span><span class="sxs-lookup"><span data-stu-id="e5138-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="e5138-105">لمزيد من المعلومات ، راجع [الاسئله المتداولة حول المجالات.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="e5138-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
