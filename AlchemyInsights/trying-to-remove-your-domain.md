...
لإزالة المجال الخاص بك من Microsoft، اتبع الخطوات في هذه المقالة: [إزالة مجال](https://docs.microsoft.com/microsoft-365/admin/get-help-with-domains/remove-a-domain)
  
ستحتاج إلى تحديث أي مستخدمين أو مجموعات تم تعيينها إلى اسم النطاق هذا قبل إزالة المجال.
