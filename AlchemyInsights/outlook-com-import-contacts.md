...
ms.locfileid: "53962190"
---
# <a name="import-contacts"></a>استيراد جهات الاتصال

قبل استيراد جهات الاتصال إلى Outlook.com، ستحتاج إلى تصديرها من موفر البريد الإلكتروني الآخر كملف .csv آخر. بعد ذلك، اتبع الإرشادات أدناه.
...
.
2. في أعلى الصفحة، حدد **إدارة** \> **استيراد جهات الاتصال**.
3. حدد **استعراض**، وانتقل إلى المجلد حيث حفظت جهات الاتصال التي قمت بتصديرها، وحدد **فتح**.
