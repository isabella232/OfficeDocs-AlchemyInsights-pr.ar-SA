...
ms.locfileid: "50709345"
---
# <a name="troubleshooting-missing-files-or-folders-in-onedrive-or-sharepoint"></a>استكشاف الأخطاء في الملفات أو المجلدات المفقودة في OneDrive أو SharePoint وإصلاحها

- [التحقق من سلة معادلات الموقع](https://support.microsoft.com/office/restore-items-in-the-recycle-bin-that-were-deleted-from-sharepoint-or-teams-6df466b6-55f2-4898-8d6e-c0dff851a0be)
...
تحقق من عميل المزامنة من OneDrive على جهازك المحلي.  إذا كنت تقوم بمزامنة الملفات الموجودة على الكمبيوتر عبر عميل المزامنة من OneDrive، فتحقق من مجلد المزامنة المحلي للتأكد من تحميله بشكل صحيح. تأكد أيضا من فحص سلة المعاد تدويرها على جهازك المحلي.
