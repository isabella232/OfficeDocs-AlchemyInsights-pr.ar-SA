...
---
# <a name="migrate-options-to-sharepoint-online"></a>ترحيل الخيارات إلى SharePoint Online

تتوفر خيارات مختلفه لترحيل المحتوي إلى SharePoint Online ، استنادا إلى حجم الملفات التي تحتاج إلى نقلها وكميتها.
