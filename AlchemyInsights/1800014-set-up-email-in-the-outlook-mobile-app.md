...
ms.locfileid: "30244352"
---
# <a name="set-up-email-in-the-outlook-mobile-app"></a>إعداد بريد إلكتروني في Outlook التطبيق المحمول

1. حدد **الشروع في العمل** إذا كانت هي المرة الأولى إعداد البريد الإلكتروني في app. المتنقلة إلا وانقر فوق **القائمة** ثم انقر فوق **إعدادات** \> **إضافة حساب** \> **إضافة حساب البريد الإلكتروني**. 
