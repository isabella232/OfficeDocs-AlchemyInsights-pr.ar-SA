...
---
# <a name="update-dns-records-at-bluehost"></a>تحديث سجلات DNS في Bluehost

استخدم الارتباطات أدناه للمساعدة في تحديث سجلات DNS.

- [إنشاء سجلات DNS في Bluehost](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-bluehost?view=o365-worldwide)
