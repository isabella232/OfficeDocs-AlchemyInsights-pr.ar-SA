...
إذا كان صندوق بريد المستخدم "يستعد" لأكثر من ساعة، يمكنك محاولة حذف المستخدم ثم إعادة إنشائه، أو استخدام خيار "دعونا نتصل بك" للتحدث إلى مهندس دعم.
