...
ms.locfileid: "30759389"
---
# <a name="open-a-sharepoint-library-in-file-explorer"></a>فتح مكتبة SharePoint في "مستكشف الملفات"

1. استعرض بحثاً عن مكتبة في Internet Explorer 10 أو 11 مستكشف إنترنت. 
    
2. انقر فوق الرمز طريقة العرض في الجزء الأيسر العلوي ومن ثم انقر فوق **طريقة عرض في "مستكشف الملفات"**.
