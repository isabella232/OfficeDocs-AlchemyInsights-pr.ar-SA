...
- لتعيين **تراخيص** A5 للمستخدمين، انتقل إلى **> [التراخيص.](https://go.microsoft.com/fwlink/p/?linkid=842264)** لمزيد من المعلومات، اطلع على [تعيين التراخيص للمستخدمين](https://docs.microsoft.com/microsoft-365/admin/manage/assign-licenses-to-users).
...
- لإلغاء **اشتراك** A5، انتقل إلى الفوترة > منتجاتك، حدد الاشتراك، وفي قسم إعدادات الاشتراك **والدفع،** حدد **إلغاء الاشتراك.** **[](https://go.microsoft.com/fwlink/p/?linkid=842054)** لمزيد من المعلومات، اطلع على [إلغاء اشتراكك](https://docs.microsoft.com/microsoft-365/commerce/subscriptions/cancel-your-subscription).
