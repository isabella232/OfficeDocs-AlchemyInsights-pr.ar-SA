---
title: استكشاف الأخطاء وإصلاحها باستخدام Apple MDM Push Certificate في Microsoft Intune
ms.author: pebaum
author: pebaum
manager: scotv
ms.date: 04/21/2020
...
ms.locfileid: "54048107"
---
# <a name="troubleshoot-issues-with-apple-mdm-push-certificate-in-microsoft-intune"></a>استكشاف الأخطاء وإصلاحها باستخدام Apple MDM Push Certificate في Microsoft Intune

راجع الموارد المدرجة أدناه لحل المشكلة الآن.
  
1. راجع [هذا المستند](https://docs.microsoft.com/intune/apple-mdm-push-certificate-get) لتكوين شهادة دفع Apple MDM أو تجديدها.
