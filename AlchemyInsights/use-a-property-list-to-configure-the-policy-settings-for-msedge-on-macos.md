...
---
# <a name="use-a-property-list-to-configure-the-policy-settings-for-microsoft-edge-on-macos"></a>استخدام قائمة خاصية لتكوين إعدادات النهج ل Microsoft Edge على macOS

في macOS، يمكن تكوين الإصدار 77 من Microsoft Edge أو الإصدارات الأحدث باستخدام ملف قائمة الخاصية (plist.):
