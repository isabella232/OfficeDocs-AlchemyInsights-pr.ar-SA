...
إذا كنت تريد تغيير طريقة الدفع لاشتراك حالي، فاتبع الإرشادات [هنا](https://docs.microsoft.com/office365/admin/subscriptions-and-billing/change-payment-method).
  
**معلومات إضافية**
  
[دفع قيمة اشتراكك في Office 365 for Business](https://docs.microsoft.com/office365/admin/subscriptions-and-billing/pay-for-your-subscription)