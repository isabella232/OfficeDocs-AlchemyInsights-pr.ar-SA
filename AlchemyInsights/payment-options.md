...
إذا كنت تريد تغيير طريقة الدفع لاشتراكك، اتبع الإرشادات الموجودة [هنا](https://docs.microsoft.com/en-us/office365/admin/subscriptions-and-billing/change-payment-method?view=o365-worldwide).
  
 **معلومات إضافية**
  
[الدفع مقابل الخاص بك Office 365 لاشتراك الأعمال](https://docs.microsoft.com/en-us/office365/admin/subscriptions-and-billing/pay-for-your-subscription?view=o365-worldwide)
