...
إليك الوقت الذي يمكنك فيه استدعاء الرسائل أو لا يمكنك تذكرها:

* ب أنت المسؤول، يمكنك استدعاء الرسائل نيابة عن المستخدمين باستخدام PowerShell. لا يمكنك استدعاء الرسائل من مركز الإدارة.
