...
- تحتاج إلى استخدام ميزة البحث سجل التدقيق في & أمان مركز التوافق لاسترداد SharePoint والمتعلقة أونيدريفي سجلات التدقيق. لمزيد من المعلومات، راجع [البحث سجل التدقيق](https://docs.microsoft.com/office365/securitycompliance/search-the-audit-log-in-security-and-compliance#search-the-audit-log).
