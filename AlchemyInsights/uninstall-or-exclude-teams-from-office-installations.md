...
يتم الآن تضمين فرق Microsoft كجزء من Office 365 ProPlus ، مكتب 365 الاعمال ، ومكتب لنظام التشغيل Mac.
...
- استخدم الخيار [بريفينتفيرستلونتشافتيرينستال](https://docs.microsoft.com/deployoffice/teams-install#use-group-policy-to-prevent-microsoft-teams-from-starting-automatically-after-installation) ، *قبل تثبيت الفرق*، لمنع فرق Microsoft من بدء التشغيل تلقائيا بعد التثبيت.
