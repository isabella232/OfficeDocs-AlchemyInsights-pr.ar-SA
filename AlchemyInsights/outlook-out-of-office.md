...
---
# <a name="set-up-out-of-office-automatic-replies"></a>اعداد الردود التلقائية ل office

- [كيفيه تعيين الردود التلقائية علي علبه بريد المستخدم في Microsoft 365](https://docs.microsoft.com/exchange/troubleshoot/configure-mailboxes/set-automatic-replies)
