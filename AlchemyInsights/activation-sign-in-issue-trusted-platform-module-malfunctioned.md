...
2. باستخدام حسابات **إعدادات**  >    >  **Windows، & البريد الإلكتروني،** قم بإزالة حسابات العمل الموجودة. 
3. باستخدام **حسابات** إعدادات Windows  >    >  **Access للعمل أو المدرسة**، قم بقطع الحسابات الموجودة. 
