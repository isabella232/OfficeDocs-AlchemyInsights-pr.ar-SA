...
---
# <a name="verify-your-domain-with-google-enom"></a>التحقق من مجالك باستخدام Google (eNom)
...
راجع [إنشاء سجلات DNS عند إدارة مجالك بواسطة Google (eNom)](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-for-domain-managed-by-google-enom) للحصول على إرشادات مفصلة خطوة بخطوة.