...
ms.locfileid: "53928608"
---
# <a name="disable-onedrive"></a>تعطيل OneDrive

هناك عدة طرق يمكنك من خلالها تعطيل الوصول إلى OneDrive وخدماتها وفقا لاحتياجات عملك:

[إلغاء ارتباط التطبيق أو إخفائه أو OneDrive تثبيته](https://support.office.com/article/turn-off-disable-or-uninstall-onedrive-f32a17ce-3336-40fe-9c38-6efb09f944b0)

[السماح بالمزامنة فقط لمنظمات معينة](https://docs.microsoft.com/onedrive/use-group-policy#allow-syncing-onedrive-accounts-for-only-specific-organizations)
...
[تعطيل البيانات المزامنة من OneDrive](https://docs.microsoft.com/onedrive/use-group-policy#DisablePersonalSync)
