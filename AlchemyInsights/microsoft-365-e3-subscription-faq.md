...
- لتعيين **تراخيص** E3 للمستخدمين، انتقل إلى **> [التراخيص.](https://go.microsoft.com/fwlink/p/?linkid=842264)** لمزيد من المعلومات، اطلع على [تعيين التراخيص للمستخدمين](https://docs.microsoft.com/microsoft-365/admin/manage/assign-licenses-to-users).
...
- لإلغاء **اشتراك** E3، انتقل إلى الفوترة **>[](https://go.microsoft.com/fwlink/p/?linkid=842054)** منتجاتك، وحدد  الاشتراك، وفي قسم إعدادات الاشتراك والدفع، حدد **إلغاء الاشتراك.** لمزيد من المعلومات، اطلع على [إلغاء اشتراكك](https://docs.microsoft.com/microsoft-365/commerce/subscriptions/cancel-your-subscription).
