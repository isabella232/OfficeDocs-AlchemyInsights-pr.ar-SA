...
---
# <a name="restore-deleted-items-from-sharepoint"></a>استعادة العناصر المحذوفة من SharePoint

عند حذف عنصر أو موقع من SharePoint، لا تتم إزالته مباشرة. تنتقل العناصر المحذوفة إلى "سله المحذوفات" لفترة زمنية. خلال ذلك الوقت، يمكنك استعادة العناصر التي حذفتها إلى موقعها الأصلي. لمزيد من المعلومات، يرجى زيارة الارتباطات أدناه.
...
- [حذف العناصر أو إفراغ سلة المعاد تدويرها](https://support.office.com/article/delete-items-or-empty-the-recycle-bin-of-a-sharepoint-site-2e713599-d13e-40d6-96dc-66f0a366f74e#ID0EAADAAA=Online)
...
- [استعادة ملف محذوف OneDrive](https://docs.microsoft.com/onedrive/restore-deleted-onedrive)

- [SharePoint PNP عبر الإنترنت](https://docs.microsoft.com/powershell/sharepoint/sharepoint-pnp/sharepoint-pnp-cmdlets?view=sharepoint-ps)
