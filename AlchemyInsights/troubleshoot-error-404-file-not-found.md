...
للمواقع التقليدية الموجودة في مركز الإدارة التقليدية، راجع [استعادة مجموعة موقع حذف](https://docs.microsoft.com/sharepoint/restore-deleted-site-collection).


للمواقع الحديثة (الاتصالات المتصلة بالمجموعة، أو مواقع أخرى) الموجودة في مركز مسؤول SharePoint جديد، راجع [حذف طريقة العرض واستعادة المواقع في مركز مسؤول SharePoint جديدة](https://docs.microsoft.com/sharepoint/restore-deleted-site-collection).
