...
---
# <a name="different-types-of-shared-outlook-calendars-and-how-to-set-them-up"></a>أنواع مختلفة من تقويمات Outlook المشتركة وكيفية إعدادها

- [إنشاء علبة بريد مشتركة](https://docs.microsoft.com/microsoft-365/admin/email/create-a-shared-mailbox)

- [علبتا بريد الأجهزة والغرف](https://docs.microsoft.com/microsoft-365/admin/manage/room-and-equipment-mailboxes)
